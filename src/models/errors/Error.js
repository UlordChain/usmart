...
export default class Error {
    ...
    static locked(){
        return new Error(ErrorTypes.LOCKED, "The user's Usmart is locked. They have been notified and should unlock before continuing.")
    }
    ...
    static requiresUpgrade(){
        return new Error(ErrorTypes.UPGRADE_REQUIRED, "The required version is newer than the User's Usmart", ErrorCodes.UPGRADE_REQUIRED)
    }
