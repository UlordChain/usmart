...
export const BUTTON_AutoLock = 'btn_auto_lock';// 新添加

export const VIEW_LOGOUT_LAST = 'view_out_last';// 新添加
export const VIEW_LOGOUT_LASTMSG = 'view_out_msg';// 新添加
...
export const ALERT_Copy = 'alert_copy';
