...
export default {
    ...
    [KEYS.PLACEHOLDER_NewPassword]:'New Password(Minimum 8 characters)',
    ...
    [KEYS.BUTTON_DestroyScatter]:'Logout USmart',
    [KEYS.BUTTON_CreateNewScatter]:'Create New USmart',
    [KEYS.BUTTON_LoadFromBackup]:'Load From Backup',
    [KEYS.BUTTON_Unlock]:'Unlock',
    [KEYS.BUTTON_ExportScatter]:'Export USmart',
    ...
    [KEYS.BUTTON_AutoLock]:'ChangeTimeout',         //新添加
    [KEYS.VIEW_LOGOUT_LAST]:'Destroying Usmart',  //新添加
    [KEYS.VIEW_LOGOUT_LASTMSG]:'This is your last chance to double check your backups.',  //新添加
    ...
    [KEYS.ALERT_Copy]:`Copied public key and key to clipboard`,
    ...
    [KEYS.HISTORIES_Description]:`
        Once you have them, you will be able to see a list of all of the events that pass through your USmart.
        What you will not see is events that occurred on your accounts outside of USmart.
     `,
    [KEYS.HISTORIES_Note]:`
        Note: Exporting your USmart data from the backup option in the settings panel does not save these events.
        When you import that USmart instance again your histories will be empty. If you would like to export your histories
    ...
    [KEYS.SETTINGSMENU_Destroy]:'Logout',

    [KEYS.BACKUP_Header]:`Export encrypted backup`,
    [KEYS.BACKUP_Description]:`
        Exporting your USmart allows you to import it into other devices. The file will still be encrypted when it is 
    ...
    [KEYS.IMPORT_Description]:`
        Importing your encrypted keychain file will rebuild you USmart keychain but it will not import your old networks or 
        accounts. 
    `,
    ...
    [KEYS.DESTROY_Header]:`Logout USmart`,
    [KEYS.DESTROY_Description]:`
        You are about to logout your entire USmart keychain. The only way to get this exact USmart back is by 
        importing an exported USmart JSON. You will not be able to claim your identities otherwise. Make sure you 
        have exported your USmart from the backup settings panel before hand.
    `,
    ...
    `,
    [KEYS.KEYPAIR_Important]:`Save your private key elsewhere! You can not take private keys back out of USmart.`,
    ...
    [KEYS.LOCK_Description]:`
        Auto Lock handles USmart's locking for you so that you don't have to 
        remember to lock your USmart when you step away.
    `,
    ...
    [KEYS.MNEMONIC_Description]:`Mnemonics in USmart are only used for password recovery.`,
    [KEYS.MNEMONIC_Note]:`
        Be sure to save yours somewhere safe. It is the only way to regain access to your 
        USmart and decrypt your private information if you forget your password.
    `,
    ...
    [KEYS.ALERT_RemovingEndorsedNetwork]:[
        ...
        `You cannot remove USmart's endorsed Networks.`
    ],
    //2
    ...
    [KEYS.REQUEST_AddNetwork]:[
        /*{DOMAIN}*/ 'wants to add their network to your USmart.',

        'Some applications use their own Networks.',

        `This in no way gives the application any access to your USmart. 
    ...
    [KEYS.REQUEST_ScatterIsLocked]:[
        `Your USmart is locked!`,

        `Before you can do anything with your USmart you will need to unlock it.`,
        ...
        `If you see a prompt/popup which is requesting your password, it is a malicious website trying to get your password.
         Always only unlock USmart from the extension's popup by clicking on the icon in your browser tray.`
    ],
    //4
    [KEYS.REQUEST_UpdateVersion]:[
        `Your USmart is out of date!`,

        /*{DOMAIN}*/ `is requiring you have a version of USmart that is newer than the one installed.`,
        ...
        `Please Note, we leave version checking up to the applications themselves. They could be maliciously trying to
         get you to download something. Make sure you always download USmart from the proper location.`
    ],
