...
// console.log(camelCase("get_Table_Row"))
...
export default class Background {
    ...
    static identityFromPermissions(sendResponse, payload){
        // console.log("identityFromPermissions",payload)
        if(!seed.length) {
            sendResponse(null);
            return false;
        }
    ...
    static getOrRequestIdentity(sendResponse, payload){
        // console.log("getOrRequestIdentity",payload)
        this.lockGuard(sendResponse, () => {
            Background.load(scatter => {
    ...
    static forgetIdentity(sendResponse, payload){
        // console.log("forgetIdentity",payload)
        this.lockGuard(sendResponse, () => {
            Background.load(scatter => {
    ...
    static authenticate(sendResponse, payload){
        ...
        this.lockGuard(sendResponse, () => {
            Background.load(scatter => {
                ...
                const plugin = PluginRepository.plugin(Blockchains.UOS);
                // console.log("签名",payload.domain)
    ...
    static requestSignature(sendResponse, payload){
        // console.log("requestSignature",payload)
        this.lockGuard(sendResponse, () => {
            Background.load(scatter => {
    ...
    static requestArbitrarySignature(sendResponse, payload){
        // console.log("requestArbitrarySignature",payload)
        this.lockGuard(sendResponse, () => {
            Background.load(scatter => {
    ...
    static requestAddNetwork(sendResponse, payload){
        // console.log("requestAddNetwork",payload)
        this.lockGuard(sendResponse, () => {
            Background.load(scatter => {
