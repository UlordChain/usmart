...
class Content {
    ...
    setupEncryptedStream(){
        ...
        stream.onSync(async () => {
            ...
            //把 Scatterdapp 应用程序信息/身份信息 发送到 比如 k3 这样的网站
            // Pushing an instance of Scatterdapp to the web application
            // console.log("tab",JSON.stringify(NetworkMessageTypes.PUSH_SCATTER, {version, identity}), PairingTags.INJECTED);
